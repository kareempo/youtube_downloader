...
"padding:4px;")
        ...
        self.title.setGeometry(QtCore.QRect(30, 120, 471, 61))
        self.title.setMinimumSize(QtCore.QSize(471, 61))
        self.title.setMaximumSize(QtCore.QSize(471, 61))
        font = QtGui.QFont()
...
"color:black;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title.setText(_translate("MainWindow", "عنوان الفيديو"))
